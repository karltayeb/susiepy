...
from susiepy.utils import polya_gamma_mean, normal_kl, categorical_kl
...
@jit
def fit_univariate_vb_fixed_xi(data: dict, re: dict, params: dict):
    def vb_cond(val):
        return val['track']['diff'] > 1e-6
    # initialize
    # data = dict(x=x, y=y)
    ...
    # iterate updates until convergence
    res = while_loop(vb_cond, vb_iter2, val_init)
    # return results

...
from susiepy.ser import fit_tilted_ser, fit_uvb_ser
from susiepy.ser import initialize_re, initialize_ser_params
from susiepy.utils import map_nested_dicts

def pluck(dicts: dict, k) -> np.ndarray:
    """Pull key from dictionariy of dictionaries
...
def make_ibss2m(ser_fun):
    ...
    return ibss2m_jax, ibss2m_driver, ibss2m_iter
    
ibss2m_tilted, ibss2m_tilted_driver, ibss2m_tilted_iter = make_ibss2m(fit_tilted_ser)
ibss2m_uvb, ibss2m_uvb_driver, ibss2m_uvb_iter = make_ibss2m(fit_uvb_ser)
